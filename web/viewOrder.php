...
<div class="py-3 bg-domus">
    <div class="container">
        <h6 class="text-white"><a href="index.php" class="text-white">Home/</a><a href="myOrders.php" class="text-white">My Orders/</a><a href="#" class="text-white">View Order</a></h6>
    </div>
</div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-domus">
                            ...
                            <a href="myOrders.php" class="btn btn-domus float-end"> <i class="fa fa-reply"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
